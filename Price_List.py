...
lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Letti-Chokidar", fg="steel blue", anchor=W)
...
lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Cheese Sandwich", fg="steel blue", anchor=W)
...
lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Hot Gulab Ja mun with Icecream", fg="steel blue", anchor=W)
